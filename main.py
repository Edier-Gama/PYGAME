...
FE = pygame.image.load("assets/fondo_empate.jpg")
...
def play():   
 ...
 while True:
    ...
    if score == score_bot and vidas <= 0:
        menu_final_empate()
    if score_bot > score and mechaLista == 0:
        menu_final()        
...
def menu_final_empate():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("assets/Play Rect.png"), pos=(200, 540), 
                            text_input="JUGAR DE NUEVO", font=get_font(35), base_color="black", hovering_color="green")
        QUIT_BUTTON = Button(image=pygame.image.load("assets/Quit Rect.png"), pos=(650, 540), 
                            text_input="SALIR", font=get_font(35), base_color="black", hovering_color="red")
...
def main_menu():
    while True:
        ...
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/Options Rect.png"), pos=(450, 400), 
                            text_input="CÓMO JUGAR", font=get_font(35), base_color="black", hovering_color="green")
